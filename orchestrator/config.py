...
DEFAULT_CONFIG: dict[str, Any] = {
    ...
    "review": {
        ...
        "hook_mode": "setup",
        "auto_max_ratio": 0.40,
        "auto_soft_cap_s": 2100.0,
        "auto_hard_cap_s": 2700.0,
    ...
    "shots": {
        ...
        "face_detection": "on",
        "min_brightness": 0.06,
        "end_credit_guard": False,
        "end_credit_tail_s": 600.0,
        "end_credit_threshold": 0.60,
        "skip_intro": 0.0,
        "skip_outro": 0.0,
        "downscale": "auto",
        "scene_threshold": 0.3,
    ...
    "match": {
        ...
        "content_anchors": True,
        "sentence_refinement_mode": "off",
        "allow_repeat": True,
        "allow_speedfit": False,
        "exclude_non_story": True,
        "exclude_end_credits": False,
