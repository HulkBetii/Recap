...
def test_write_review_html_contains_summary_and_escapes_text(tmp_path: Path) -> None:
    ...
    qa = {"n_intro_excluded": 0, "selected_from_non_story": False, "beats": [{"beat_id": 0, "avg_semantic_score": 0.5, "warnings": ["low semantic"], "selected": [{"semantic_score": 0.5, "semantic_rank": 1}]}]}
