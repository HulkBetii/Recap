...
General coding and communication guidelines for AI agents.
Project-specific source of truth is `AGENTS.md`; if there is any conflict, follow `AGENTS.md` first.
