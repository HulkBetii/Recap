...
- Visual planning uses light zoom/pan, mood grade, limited 2.35:1 masks, key-beat push-ins, transition-only three-slice ramps, and guarded 0.45s freeze frames. Source extensions stay inside the same indexed shot; skipped effects and bound checks are recorded in QA.
