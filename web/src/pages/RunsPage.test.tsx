...
describe("RunsPage", () => {
  it("renders runtime state and discovered season runs", async () => {
    ...
    vi.spyOn(api, "jobs").mockResolvedValue([{ id: "job-1", kind: "series", title: "Solo Leveling S01", run_name: "solo-leveling-s01", status: "running", current_stage: "series_composer", created_at: "2026-07-24T00:00:00Z" }]);
