...
- Speed ramp is transition/bridge-only and uses frame-locked `1.0/1.15/1.35` slices in the final 40% or less. It may extend source only inside the same indexed shot; insufficient headroom skips the effect and records QA. Reveal/climax never receive auto ramp.
