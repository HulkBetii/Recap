    ...
    *,
    ...
    for beat in beats:
        ...
        beat_reports.append({
            ...
            "local_expansion_used": bool(candidate_info.get("local_expansion_used", False)),
            "local_expansion_gap_s": candidate_info.get("local_expansion_gap_s", 0.0),
            "local_expansion_capacity_floor_s": candidate_info.get("local_expansion_capacity_floor_s", 0.0),
            "object_visual_priority": bool(candidate_info.get("object_visual_priority", False)),
