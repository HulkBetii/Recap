...
def render_temp_clips(*, source_paths: dict[str, Path], source_durations: dict[str, float], frames, params: RenderParams, cache: RenderCache, concurrency: int) -> tuple[list[Path], list[str]]:
    warnings: list[str] = []
